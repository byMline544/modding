...
public class ContainerElectricFurnace extends Container {
    ...
    private final TileEntityElectricFurnace machine;
    private int lastProgress;
    private int lastEnergy;

    public ContainerElectricFurnace(InventoryPlayer playerInventory, TileEntityElectricFurnace machine) {
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < this.crafters.size(); ++i) {
            ...
            if (lastEnergy != machine.getStorage().getEnergyStored() * 10000 / machine.getStorage().getMaxEnergyStored()) {
                crafting.sendProgressBarUpdate(this, 1, machine.getStorage().getEnergyStored() * 10000 / machine.getStorage().getMaxEnergyStored());
            }
        }
