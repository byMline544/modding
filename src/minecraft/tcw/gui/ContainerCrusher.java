...
public class ContainerCrusher extends Container {
    ...
    public ContainerCrusher(InventoryPlayer playerInventory, TileEntityCrusher crusher) {
        ...
        for (int i = 0; i < crusher.getModuleSlotCount(); i++) {
            addSlotToContainer(new SlotMachineModule(crusher, crusher.getModuleSlotStart() + i, 152, 8 + i * 16));
        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index < 2 + crusher.getModuleSlotCount()) {
