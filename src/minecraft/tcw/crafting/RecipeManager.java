...
public class RecipeManager {
    ...
    private static void registerSolarPanels() {
        ...
        GameRegistry.addRecipe(new ItemStack(BlockManager.batBox), "CPC", "BMB", "CCC", 'C', ItemManager.cable, 'P', ItemManager.reinforcedPlate, 'B', ItemManager.batteryBasic, 'M', BlockManager.machineCasing);
        GameRegistry.addRecipe(new ItemStack(BlockManager.mfe), "CPC", "BMB", "CAC", 'C', ItemManager.cable, 'P', ItemManager.reinforcedPlate, 'B', ItemManager.batteryAdvanced, 'M', BlockManager.batBox, 'A', ItemManager.advancedCircuit);
        GameRegistry.addRecipe(new ItemStack(BlockManager.mfsu), "QCQ", "MMM", "QAQ", 'Q', ItemManager.quantumCore, 'C', ItemManager.superconductiveCore, 'M', BlockManager.mfe, 'A', ItemManager.energyMatrix);
    }
