...
import tcw.crafting.WiremillRecipes;

public class TileEntityWiremill extends TileEntityInventoryMachine {
    ...
    private boolean canProcess() {
        ItemStack result = WiremillRecipes.instance().getResult(inventory[0]);
        if (result == null) {
            return false;
        }
        if (inventory[1] == null) {
